...
export abstract class ResourceLoader {
  ...
  public AddNewTextboxNote(startRectanglePoint, recWidth , recHeight , recTextNote) {
    ...
    const newTextNote = {
     ...
     console.log('Added new TextNote');
     console.log('x: ' + newTextNote.startPoint.x);
     console.log('y: ' + newTextNote.startPoint.y);
     console.log('height: ' + newTextNote.height);
     console.log('width: ' + newTextNote.width);
     console.log('text: ' + newTextNote.textNote);
  }
